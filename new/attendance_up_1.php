	...
	<section class="maincontent">
		<?php
			...
			if($selected_course=="None")
				...
				echo "<div class='selected_course'><h2>".$selected_course.".</h2></div>";
		...
		<?php
			$query_display = "select image,cs.course_info,s.student_name,cs.student_id from course_student cs,student s,course_faculty cf where cs.course_info='$c_info' and cs.student_id = s.student_id and cf.course_info='$c_info' and cs.semester_code='$semester_code' and cf.semester_code = '$semester_code'";
		...
		<form action="report.php" method="POST">
			<table style="margin: 0px auto" width="600" border="1"  BORDERCOLOR="#5C79F9" cellpadding="10" cellspacing="0">
				...
				<input class="insert" type="submit" value="Insert record" />
