...
<div class="phpcoding">
	...
	<section class="maincontent">
		...
		<?php
			...
			$display = "select student_name,aas.student_id,date,aas.course_info from attendance_storage aas,course_student cs,student s where aas.date='$dt' and aas.course_info='$selected_course' and aas.semester_code='$semester_code' and s.student_id = aas.student_id and aas.student_id = cs.student_id and cs.course_info = '$selected_course' and cs.semester_code = '$semester_code' ";
