...
<div class="phpcoding">
	...
	<table style="margin: 0px auto" width="600" border="1" cellpadding="10" cellspacing="1">
				...
				<?php
					$query_report_1 = "select cs.course_info,s.student_name,cs.student_id,cf.total_class,cs.class_attended from course_student cs,student s,course_faculty cf where cs.course_info='$c_info' and cs.student_id = s.student_id and cf.course_info='$c_info' and cs.semester_code='$semester_code' and cf.semester_code = '$semester_code'";
					...
					while($display=mysqli_fetch_assoc($result_report))
					{
						...
						echo "<td>".number_format((float)$Percentage_dis, 2, '.', '')."</td>";
